...
//   Corrected usage of findOneAndUpdate
...
//     if (updateResult && updateResult.modifiedCount !== userCart.products.length) {
//       return res.status(500).json({ error: "Product updates failed" });
//     }
